...
sota = {
    "alien": (405.2, 739.9, 7127.7),
    "amidar": (88, 188.6, 1719.5),
    "assault": (369.3, 431.2, 742),
    "asterix": (1089.5, 470.8, 8503.3),
    "bank_heist": (8.2, 51.0, 753.1),
    "battle_zone": (5184.4, 10124.6, 37187.5),
    "boxing": (9.1, 0.2, 12.1),
    "breakout": (12.7, 1.9, 30.5),
    "chopper_command": (1246.9, 861.8, 7387.8),
    "crazy_climber": (398217.8, 16185.3, 35829.4),
    "demon_attack": (169.5, 508.0, 1971.),
    "freeway": (20.3, 27.9, 29.6),
    "frostbite": (254.7, 886.8, 4334.7),
    "gopher": (771.0, 349.5, 2412),
    "hero": (1295.1, 6857.0, 30826),
    "jamesbond": (125.3, 301.6, 302.8),
...
rainbow_hns = []
for env in sota.keys():
    rainbow_hns.append(sota[env][1]/sota[env][2])
